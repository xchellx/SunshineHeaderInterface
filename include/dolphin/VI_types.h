...
#define VI_DEBUG                                                                                   \
    3 /*!< Video standard, for debugging purpose, used in North America and Japan. Special decoder \
         needed */
#define VI_DEBUG_PAL                                                                               \
    4 /*!< Video standard, for debugging purpose, used in Europe. Special decoder needed */
#define VI_EURGB60                                                                                 \
    5 /*!< RGB 60Hz, 480 lines mode (same timing and aspect ratio as NTSC) used in Europe */
...
#define VIDEO_PadFramebufferWidth(width)                                                           \
    ((u16)(((u16)(width) + 15) & ~15)) /*!< macro to pad the width to a multiple of 16 */
...
extern GXRenderModeObj
    TVNtsc240Ds; /*!< Video and render mode configuration for 240 lines,singlefield NTSC mode */
extern GXRenderModeObj TVNtsc240DsAa; /*!< Video and render mode configuration for 240
                                         lines,singlefield,antialiased NTSC mode */
extern GXRenderModeObj
    TVNtsc240Int; /*!< Video and render mode configuration for 240 lines,interlaced NTSC mode */
extern GXRenderModeObj TVNtsc240IntAa; /*!< Video and render mode configuration for 240
                                          lines,interlaced,antialiased NTSC mode */
extern GXRenderModeObj
    TVNtsc480Int; /*!< Video and render mode configuration for 480 lines,interlaced NTSC mode */
extern GXRenderModeObj TVNtsc480IntDf; /*!< Video and render mode configuration for 480
                                          lines,interlaced,doublefield NTSC mode */
extern GXRenderModeObj TVNtsc480IntAa; /*!< Video and render mode configuration for 480
                                          lines,interlaced,doublefield,antialiased NTSC mode */
extern GXRenderModeObj TVNtsc480Prog;  /*!< Video and render mode configuration for 480
                                          lines,progressive,singlefield NTSC mode */
...
extern GXRenderModeObj TVMpal480IntDf; /*!< Video and render mode configuration for 480
                                          lines,interlaced,doublefield,antialiased MPAL mode */
...
extern GXRenderModeObj
    TVPal264Ds; /*!< Video and render mode configuration for 264 lines,singlefield PAL mode */
extern GXRenderModeObj TVPal264DsAa; /*!< Video and render mode configuration for 264
                                        lines,singlefield,antialiased PAL mode */
extern GXRenderModeObj
    TVPal264Int; /*!< Video and render mode configuration for 264 lines,interlaced PAL mode */
extern GXRenderModeObj TVPal264IntAa; /*!< Video and render mode configuration for 264
                                         lines,interlaced,antialiased PAL mode */
extern GXRenderModeObj
    TVPal528Int; /*!< Video and render mode configuration for 528 lines,interlaced PAL mode */
extern GXRenderModeObj TVPal528IntDf; /*!< Video and render mode configuration for 528
                                         lines,interlaced,doublefield PAL mode */
extern GXRenderModeObj TVPal524IntAa; /*!< Video and render mode configuration for 524
                                         lines,interlaced,doublefield,antialiased PAL mode */

...
#define GX_FIFO_MINSIZE                                                        \
  (64 * 1024) /*!< Smallest usable graphics FIFO size.                         \
               */
#define GX_FIFO_HIWATERMARK                                                    \
  (16 * 1024) /*!< Default hi watermark for FIFO buffer control. */
 ...
 */
#define GX_POINTS                                                              \
  0xB8 /*!< Draws a series of points. Each vertex is a single point. */
#define GX_LINES                                                               \
...
#define GX_CTF_RA4                                                             \
  (0x2 | _GX_TF_CTF) /*!< For copying 4 bits from red, 4 bits from alpha */
#define GX_CTF_RA8                                                             \
  (0x3 | _GX_TF_CTF) /*!< For copying 8 bits from red, 8 bits from alpha */
...
#define GX_CTF_RG8                                                             \
  (0xB | _GX_TF_CTF) /*!< For copying 8 bits from red, 8 bits from green */
#define GX_CTF_GB8                                                             \
  (0xC | _GX_TF_CTF) /*!< For copying 8 bits from green, 8 bits from blue */
...
#define GX_TF_Z8                                                               \
  (0x1 | _GX_TF_ZTF) /*!< For texture copy, specifies upper 8 bits of Z */
#define GX_TF_Z16                                                              \
  (0x3 | _GX_TF_ZTF) /*!< For texture copy, specifies upper 16 bits of Z */
#define GX_TF_Z24X8                                                            \
  (0x6 | _GX_TF_ZTF) /*!< For texture copy, copies 24 Z bits and 0xFF */
...
#define GX_CTF_Z8M                                                             \
  (0x9 | _GX_TF_ZTF | _GX_TF_CTF) /*!< For copying the middle 8 bits of Z */
#define GX_CTF_Z8L                                                             \
  (0xA | _GX_TF_ZTF | _GX_TF_CTF) /*!< For copying the lower 8 bits of Z */
#define GX_CTF_Z16L                                                            \
  (0xC | _GX_TF_ZTF | _GX_TF_CTF) /*!< For copying the lower 16 bits of Z */
...
#define GX_DECAL                                                               \
  1 /*!< <i>Cv</i>=(1-<i>At</i>)<i>Cr</i> + <i>AtCt</i>; <i>Av</i>=<i>Ar</i>   \
     */
#define GX_BLEND                                                               \
  2 /*!< <i>Cv=(1-<i>Ct</i>)<i>Cr</i> + <i>Ct</i>; <i>Av</i>=<i>AtAr</i> */
...
#define GX_PERF0_CLIP_VTX                                                      \
  1 /*!< Number of vertices that were clipped by the GP. */
...
#define GX_PERF0_XF_XFRM_CLKS                                                  \
  5 /*!< Number of cycles the transform engine is busy. */
#define GX_PERF0_XF_LIT_CLKS                                                   \
  6 /*!< Number of cycles the lighting engine is busy. */
#define GX_PERF0_XF_BOT_CLKS                                                   \
  7 /*!< Number of cycles the bottom of the pipe (result combiner) is busy. */
#define GX_PERF0_XF_REGLD_CLKS                                                 \
  8 /*!< Number of cycles are spent loading XF state registers. */
#define GX_PERF0_XF_REGRD_CLKS                                                 \
  9 /*!< Number of cycles the XF reads the state registers. */
...
#define GX_PERF0_TRIANGLES_PASSED                                              \
  13 /*!< Number of triangles that <i>passed</i> the front-face/back-face      \
        culling test. */
#define GX_PERF0_TRIANGLES_SCISSORED                                           \
  14 /*!< Number of triangles that are scissored. */
...
#define GX_PERF0_QUAD_NON0CVG                                                  \
  28 /*!< Number of quads having coverage greater than zero. */
...
#define GX_PERF0_AVG_QUAD_CNT                                                  \
  33 /*!< Average quad count; average based on what is unknown */
...
#define GX_PERF1_TX_IDLE                                                       \
  1 /*!< Number of clocks that the texture unit (TX) is idle. */
...
#define GX_PERF1_FIFO_REQ                                                      \
  17 /*!< Number of lines (32B) read from the GP FIFO. */
#define GX_PERF1_CALL_REQ                                                      \
  18 /*!< Number of lines (32B) read from called display lists. */

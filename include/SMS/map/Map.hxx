...
public:
    ...
    f32 checkGroundIgnoreWaterSurface(f32 x, f32 y, f32 z, TBGCheckData **out) const;
    f32 checkGroundIgnoreWaterSurface(const TVec3f &pos, TBGCheckData **out) const;
    f32 checkGroundIgnoreWaterThrough(f32 x, f32 y, f32 z, TBGCheckData **out) const;
    f32 checkRoof(f32 x, f32 y, f32 z, TBGCheckData **out) const;
    f32 checkRoof(const TVec3f &pos, TBGCheckData **out) const;
    f32 checkRoofIgnoreWaterThrough(f32 x, f32 y, f32 z, TBGCheckData **out) const;
    void draw(u32, JDrama::TGraphics *) const;
    TBGCheckData *getIllegalCheckData();
    TBGCheckData *intersectLine(const TVec3f &a, const TVec3f &b, bool, TVec3f *);

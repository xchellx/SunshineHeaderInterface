 ...
 *   void __isync (void);
 */
#define __isync() __asm__ volatile("isync")
...
#define __rlwinm(rS, cnt, mb, me)                                                                  \
    ({                                                                                             \
        unsigned int val;                                                                          \
        __asm__("rlwinm %0,%1,%2,%3,%4" : "=r"(val) : "r"(rS), "n"(cnt), "n"(mb), "n"(me));        \
        /*return*/ val;                                                                            \
    })
...
static inline double __setflm(double newflm) {
    double original;
...
static inline double __fabs(double value) {
    double result;
    __asm__("fabs %0, %1"
            /* outputs:  */
            : "=f"(result)
...
static inline double __fnabs(double b) {
    double result;
    __asm__("fnabs %0, %1"
            /* outputs:  */
            : "=f"(result)
...
static inline double __fctiwz(double b) {
    double result;
    __asm__("fctiwz %0, %1"
            /* outputs:  */
            : "=f"(result)
...
static inline double __fctidz(double b) {
    double result;
    __asm__("fctidz %0, %1"
            /* outputs:  */
            : "=f"(result)
...
static inline double __fctid(double b) {
    double result;
    __asm__("fctid %0, %1"
            /* outputs:  */
            : "=f"(result)
...
static inline double __fcfid(double b) {
    double result;
    __asm__("fcfid %0, %1"
            /* outputs:  */
            : "=f"(result)
...
static inline double __fmadd(double a, double c, double b) {
    double result;
...
static inline float __fmadds(double a, double c, double b) {
    float result;
...
static inline float __fmsubs(double a, double c, double b) {
    float result;
...
static inline double __fmul(double a, double c) {
    double result;
    __asm__("fmul %0, %1, %2"
            /* outputs:  */
            : "=f"(result)
...
static inline float __fmuls(double a, double c) {
    float result;
    __asm__("fmuls %0, %1, %2"
            /* outputs:  */
            : "=f"(result)
...
static inline double __fnmadd(double a, double c, double b) {
    double result;
...
static inline float __fnmadds(double a, double c, double b) {
    float result;
...
static inline double __fnmsub(double a, double c, double b) {
    double result;
...
static inline float __fnmsubs(double a, double c, double b) {
    float result;
...
static inline float __fres(float val) {
    float estimate;
    __asm__("fres %0,%1"
            /* outputs:  */
            : "=f"(estimate)
...
static inline float __frsp(double d) {
    float result;
    __asm__("frsp %0, %1"
            /* outputs:  */
            : "=f"(result)
...
static inline double __frsqrte(double val) {
    double estimate;
...
static inline float __frsqrtes(double f) {
    float result;
    __asm__("frsqrte %0, %1"
            /* outputs:  */
            : "=f"(result)
...
static inline double __fsel(double test, double a, double b) {
    double result;
...
static inline float __fsels(double test, double a, double b) {
    float result;
    __asm__("fsel %0,%1,%2,%3"
            /* outputs:  */
            : "=f"(result)
...
static inline double __fsqrt(double d) {
    double result;
    __asm__("fsqrt %0, %1"
            /* outputs:  */
            : "=f"(result)
...
static inline float __fsqrts(float f) {
    float result;
    __asm__("fsqrts %0, %1"
            /* outputs:  */
            : "=f"(result)
...
static inline int __mulhw(int a, int b) {
    int result;
    __asm__("mulhw %0, %1, %2"
            /* outputs:  */
            : "=r"(result)
...
#define __stfiwx(value, base, index)                                                               \
    __asm__("stfiwx %0, %1, %2"                                                                    \
            : /*no result*/                                                                        \
            : "f"(value), "b%"(index), "r"(base)                                                   \
            : "memory")
 ...
 *   void __nop();
 */
#define __nop() __asm__("ori 0,0,0")
...
static inline double __mffs(void) {
    double result;
 ...
 */
#define __mtfsf(mask, newValue) __asm__ volatile("mtfsf %0, %1" : : "n"(mask), "f"(newValue))
 ...
 */
static inline signed short __OSReadSwapSInt16(signed short *base, int index)
 ...
 * __OSReadSwapUInt16
 */
static inline unsigned short __OSReadSwapUInt16(volatile void *base, int inex)
    __attribute__((always_inline));
static inline unsigned short __OSReadSwapUInt16(volatile void *base, int index) {

...
#ifdef __MWERKS__
#define kmHookInt(counter) __declspec(section ".kamek") static const u32 kmIdentifier(Hook, counter)
#else
#define kmHookInt(counter)                                                                         \
    __attribute__((section(".kamek"))) static const u32 kmIdentifier(Hook, counter)
#endif
...
#define kmHook2(type, arg0, arg1) kmHookInt(__COUNTER__)[4] = {2, (type), (u32)(arg0), (u32)(arg1)}

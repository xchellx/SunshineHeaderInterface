...
namespace JGadget {
    ...
    public:
        ...
        _GLIBCXX20_CONSTEXPR iterator erase(const_iterator a, const_iterator b) {
            return erase(*iterator(a), *#pragma once
...
namespace JGadget {
                ...
                public:
                    ...
                    struct const_iterator {
                        ...
                        explicit _GLIBCXX20_CONSTEXPR const_iterator(pointer node)
                            : mCurrent(node) {}
                        _GLIBCXX20_CONSTEXPR const_iterator(const iterator &iter)
                    ...
                    TVector(const allocator_type &allocator) _GLIBCXX_NOEXCEPT
                    ...
                    _GLIBCXX20_CONSTEXPR TVector(size_type count, const value_type &value,
                                                 const allocator_type &allocator = allocator_type())
                        : mAllocator(allocator), mBegin(nullptr), mEnd(nullptr), mCapacity(0),
                          _10(2.0f), _14(0) {
                        insert(end(), count, value);
                    }
#else
...
#if __cplusplus >= 201402L
                    explicit _GLIBCXX20_CONSTEXPR
                    TVector(size_type count, const allocator_type &allocator = allocator_type())
                        : mAllocator(allocator), mBegin(nullptr), mEnd(nullptr), mCapacity(0),
                          _10(2.0f), _14(0) {
                        insert(end(), count, value_type());
                    }
                    ...
                    _GLIBCXX20_CONSTEXPR TVector &
                    operator=(JSystem::initializer_list<value_type> list) {
                        clear();
                        for (const auto &i : list) {
                            insert(end(), i);
                        }
                    ...
                    _GLIBCXX20_CONSTEXPR reference operator[](size_type index) {
                        return mBegin[index];
                    }
                    _GLIBCXX20_CONSTEXPR const_reference operator[](size_type index) const {
                        return mBegin[index];
                    ...
                    _GLIBCXX20_CONSTEXPR reference at(size_type index) {
                        if (index >= size()) {
                            /*OSReport("Attempted to access OOB item (%lu) of Vector (size %lu)!",
                            index, size()); while (true) {
                                __asm volatile("");
                            }*/
                        }
                        return mBegin[index];
                    ...
                    _GLIBCXX20_CONSTEXPR size_type capacity() const _GLIBCXX_NOEXCEPT {
                        return mCapacity;
                    }
                    _GLIBCXX20_CONSTEXPR size_type max_size() const _GLIBCXX_NOEXCEPT {
                        return difference_type(-1) / sizeof(difference_type);
                    ...
                    _GLIBCXX20_CONSTEXPR iterator begin() _GLIBCXX_NOEXCEPT {
                ...
                private:
                    _GLIBCXX20_CONSTEXPR iterator insert(pointer at, size_type count,
                                                         const_reference item) {
                        auto *ofs  = at - mBegin;
                ...
                public:
                    ...
                    insert(const_iterator at, JSystem::initializer_list<value_type> list) {
                        for (auto &i : list) {
                            at = insert(at, i);
                        }
                    }
                    ...
                    _GLIBCXX20_CONSTEXPR void push_back(const_reference item) {
                        insert(end(), item);
                    }

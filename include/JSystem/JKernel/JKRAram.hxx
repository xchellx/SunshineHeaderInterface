...
#include <JSystem/JKernel/JKRAramBlock.hxx>
#include <JSystem/JKernel/JKRAramHeap.hxx>
...
public:
    ...
    static s32 mainRamToAram(u8 *src, u32 dstAddr, size_t size, JKRExpandSwitch decompress, size_t,
                             JKRHeap *heap, int);
    static s32 aramToMainRam(u32 srcAddr, u8 *dst, size_t size, JKRExpandSwitch decompress,
                             size_t maxSize, JKRHeap *heap, int, u32 *stackSize);
    static s32 aramToMainRam(JKRAramBlock *, u8 *dst, size_t size, u32 srcAddr,
                             JKRExpandSwitch decompress, size_t maxSize, JKRHeap *heap, int,
                             u32 *stackSize);
